 ...
 *
 * Two implementations of this class are {@link ActivityHelperBase} for a pre-Honeycomb version of
 * the action bar, and {@link ActivityHelperHoneycomb}, which uses the built-in ActionBar features
...
public abstract class ActivityHelper {
    ...
    /**
     * Factory method for creating {@link ActivityHelper} objects for a
     ...
     * method in {@link ActivityHelperBase} returns a wrapped menu inflater that can read
